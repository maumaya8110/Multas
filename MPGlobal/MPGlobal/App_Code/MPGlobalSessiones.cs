...
public class MPGlobalSessiones
{
    ...
    public List<ReporteProcesados> ReporteProcesados;
    ...
    public List<UsuarioLogueado> UsuarioLogueado;
    ...
    private MPGlobalSessiones()
    {
        ...
        ReporteProcesados = new List<ReporteProcesados>();
        ...
        UsuarioLogueado = new List<UsuarioLogueado>();
    }
