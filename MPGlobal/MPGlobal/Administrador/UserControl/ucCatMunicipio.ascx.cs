...
public partial class Administrador_UserControl_ucCatMunicipio : System.Web.UI.UserControl
{
    ...
    protected void GridView1_Rowupdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        using (DataBase db = new DataBase())
        {
            ...
            parametros.Add(new SqlParameter("@nomMunicipio", ((TextBox)(row.Cells[2].Controls[1])).Text));
            parametros.Add(new SqlParameter("@siglasMunicipio", ((TextBox)(row.Cells[3].Controls[1])).Text));
