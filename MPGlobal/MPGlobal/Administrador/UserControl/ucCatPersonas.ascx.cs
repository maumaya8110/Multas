...
public partial class Administrador_UserControl_ucCatPersonas : System.Web.UI.UserControl
{
    ...
    protected void GridView1_Rowupdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        using (DataBase db = new DataBase())
        {
            ...
            //parametros.Add(new SqlParameter("@IdPersona", ((HiddenField)GridView1.Rows[e.RowIndex].Cells[1].FindControl("HiddenIdPersona")).Value )); 
            parametros.Add(new SqlParameter("@IdPersona", ((HiddenField)(row.Cells[3].Controls[1].FindControl("HiddenIdPersona"))).Value));

            
            parametros.Add(new SqlParameter("@Nombre", ((TextBox)(row.Cells[3].Controls[1])).Text));
            parametros.Add(new SqlParameter("@Apaterno", ((TextBox)(row.Cells[4].Controls[1])).Text));
            parametros.Add(new SqlParameter("@Amaterno", ((TextBox)(row.Cells[5].Controls[1])).Text));
            parametros.Add(new SqlParameter("@Licencia", ((TextBox)(row.Cells[6].Controls[1])).Text));
            parametros.Add(new SqlParameter("@INE", ((TextBox)(row.Cells[7].Controls[1])).Text));
