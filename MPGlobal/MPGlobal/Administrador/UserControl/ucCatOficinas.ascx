<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucCatOficinas.ascx.cs" Inherits="Administrador_UserControl_ucCatOficinas" %>
...
<script type="text/javascript">
    ...
    function QuestionDelete(IdOficina) {
        swal({
            ...
            function (isConfirm) {
                if (isConfirm) {
                    ...
                    document.getElementById('<%= HiddenField1AutEli.ClientID %>').value = IdOficina;
                    //return true;
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <div class="box">
            ...
            <asp:UpdatePanel ID="UpdtAgregarOficina" runat="server" Visible="false">

                <ContentTemplate>
                    <div class="panel panel-default" id="AddOficina" style="margin: 1% 2% 2% 2%;">
                        <div class="panel-heading">Alta de Oficina</div>
                        <div class="panel-body">
                            <div class="form-inline col-auto">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtOficina" runat="server" placeholder="Oficina" CssClass="form-control campo_obligatorio"></asp:TextBox>

                                    <asp:TextBox ID="txtDireccion" runat="server" placeholder="Dirección" CssClass="form-control campo_obligatorio"></asp:TextBox>
                                    ...
                                    <asp:LinkButton ID="LinkBtnAlta" runat="server" type="button" class="btn btn-default btn-sm" CommandName="LinkBtnAlta" OnClick="LinkBtnAlta_Click" data-target="#AddOficina" OnClientClick="javascript:validaCampos(this,event);">
                    ...
                    <asp:CheckBox ID="chkEliminar" runat="server" AutoPostBack="true" OnCheckedChanged="chk_OnCheckedChanged" />
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="16%">
                            <ItemTemplate>
                                ...
                                <a class="btn btn-default btn-xs" onclick="QuestionDelete('<%# Eval("IdOficina")%>');" tooltip="ELIMINAR"><span class="glyphicon glyphicon-trash"></span></a>
                        ...
                        <%-- <asp:TemplateField HeaderStyle-Width="100px" HeaderText="ID OFICINA">
                            <ItemTemplate>
                                <asp:Label ID="lblIdOficina" runat="server" Text='<%# Eval("IdOficina")%>'> </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>--%>
                        ...
                        <asp:TemplateField HeaderStyle-Width="150px" HeaderText="DIRECCION">
                            <ItemTemplate>
                                <asp:Label ID="lblDireccOficina" runat="server"><%# Eval("DireccOficina")%></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:TextBox ID="TxtDireccOficina" runat="server" Text='<%# Bind("DireccOficina")%>' CssClass="form-control"></asp:TextBox>
                            </EditItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderStyle-Width="150px" HeaderText="TELEFONO">
                            <ItemTemplate>
                                <asp:Label ID="lblTelefOficina" runat="server"><%# Eval("TelefOficina")%></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:TextBox ID="TxtTelefOficina" runat="server" Text='<%# Bind("TelefOficina")%>' CssClass="form-control"></asp:TextBox>
                            </EditItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderStyle-Width="150px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderText="ESTATUS">
                            <ItemTemplate>
                                <asp:CheckBox ID="chkEstatusOficina" runat="server" Checked='<%# bool.Parse(Eval("EstatusOficina").ToString()) %>' Enabled="false" />
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:CheckBox ID="chkEstatusOficina" runat="server" Checked='<%# bool.Parse(Eval("EstatusOficina").ToString()) %>' Enabled="true" />
                            </EditItemTemplate>
                        </asp:TemplateField>
