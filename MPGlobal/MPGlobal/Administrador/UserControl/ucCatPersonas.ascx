<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucCatPersonas.ascx.cs" Inherits="Administrador_UserControl_ucCatPersonas" %>
...
<script type="text/javascript">
    ...
    function QuestionDelete(IdPersona) {
        swal({
            ...
            function (isConfirm) {
                if (isConfirm) {
                    ...
                    document.getElementById('<%= HiddenField1AutEli.ClientID %>').value = IdPersona;
                    //return true;
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <div class="box">
            ...
            <asp:UpdatePanel ID="UpdtAgregarPersona" runat="server" Visible="false">

                <ContentTemplate>
                    <div class="panel panel-default" id="AddPersona" style="margin: 1% 2% 2% 2%;">
                        <div class="panel-heading">Alta de Persona</div>
                        <div class="panel-body">
                            <div class="form-inline col-auto">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtPersona" runat="server" placeholder="Nombre" CssClass="form-control campo_obligatorio"></asp:TextBox>
                    ...
                    <asp:CheckBox ID="chkEliminar" runat="server" AutoPostBack="true" OnCheckedChanged="chk_OnCheckedChanged" />
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="16%">
                            <ItemTemplate>
                                ...
                                <a class="btn btn-default btn-xs" onclick="QuestionDelete('<%# Eval("IdPersona")%>');" tooltip="ELIMINAR"><span class="glyphicon glyphicon-trash"></span></a>
                        ...
                        <%-- <asp:TemplateField HeaderStyle-Width="100px" HeaderText="ID Persona">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderStyle-Width="150px" HeaderText="NOMBRE">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="TxtNombre" runat="server" Text='<%# Bind("Nombre")%>' CssClass="form-control"></asp:TextBox>
                                 <asp:HiddenField ID="HiddenIdPersona" runat="server" Value='<%# Eval("IdPersona") %>'></asp:HiddenField>
                            </EditItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderStyle-Width="150px" HeaderText="LICENCIA">
                            <ItemTemplate>
                                <asp:Label ID="lblLicencia" runat="server"><%# Eval("Licencia")%></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:TextBox ID="TxtLicencia" runat="server" Text='<%# Bind("Licencia")%>' CssClass="form-control"></asp:TextBox>
                            </EditItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderStyle-Width="150px" HeaderText="INE">
                            <ItemTemplate>
                                <asp:Label ID="lblINE" runat="server"><%# Eval("INE")%></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:TextBox ID="TxtINE" runat="server" Text='<%# Bind("INE")%>' CssClass="form-control"></asp:TextBox>
                            </EditItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderStyle-Width="150px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderText="ESTATUS">
                            <ItemTemplate>
                                <asp:CheckBox ID="chkEstatusPersona" runat="server" Checked='<%# bool.Parse(Eval("Estatus").ToString()) %>' Enabled="false" />
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:CheckBox ID="chkEstatusPersona" runat="server" Checked='<%# bool.Parse(Eval("Estatus").ToString()) %>' Enabled="true" />
                            </EditItemTemplate>
                        </asp:TemplateField>
