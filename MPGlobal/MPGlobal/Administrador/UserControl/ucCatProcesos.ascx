<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucCatProcesos.ascx.cs" Inherits="Administrador_UserControl_ucCatProcesos" %>
...
<script type="text/javascript">
    ...
    function QuestionDelete(IdProceso) {
        swal({
            ...
            function (isConfirm) {
                if (isConfirm) {
                    ...
                    document.getElementById('<%= HiddenField1AutEli.ClientID %>').value = IdProceso;
                    //return true;
    ...
    <ContentTemplate>
        <div class="box">
            ...
            <asp:UpdatePanel ID="UpdtAgregarMpo" runat="server" Visible="false">
                ...
                <ContentTemplate>
                    <div class="panel panel-default" id="AddProceso" style="margin: 1% 2% 2% 2%;">
                        <div class="panel-heading">Alta de Proceso</div>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="16%">
                            <ItemTemplate>
                                ...
                                <a class="btn btn-default btn-xs" onclick="QuestionDelete('<%# Eval("IdProceso")%>');" tooltip="ELIMINAR"><span class="glyphicon glyphicon-trash"></span></a>
                        ...
                        <asp:TemplateField HeaderStyle-Width="150px" HeaderText="Proceso">
                            <ItemTemplate>
                                <asp:Label ID="lblNomProceso" runat="server"><%# Eval("NomProceso")%></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:TextBox ID="TxtNomProceso" runat="server" Text='<%# Bind("NomProceso")%>' CssClass="form-control"></asp:TextBox>
                                ...
                                <div class="form-group">
                                    <div class="inputGroupContainer">
                                        <div class="input-group">
                                            ...
                                            <asp:HiddenField ID="HiddenIdSistema" runat="server" Value='<%# Eval("Sistema") %>'></asp:HiddenField>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="inputGroupContainer">
                                        <div class="input-group">
                                            ...
                                            <asp:HiddenField ID="HiddenIdVentana" runat="server" Value='<%# Eval("Ventana") %>'></asp:HiddenField>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <asp:TemplateField HeaderStyle-Width="150px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderText="ESTATUS">
                            <ItemTemplate>
                                <asp:CheckBox ID="chkEstatusProceso" runat="server" Checked='<%# bool.Parse(Eval("Estatus").ToString()) %>' Enabled="false" />
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:CheckBox ID="chkEstatusProceso" runat="server" Checked='<%# bool.Parse(Eval("Estatus").ToString()) %>' Enabled="true" />
                            </EditItemTemplate>
                        </asp:TemplateField>
