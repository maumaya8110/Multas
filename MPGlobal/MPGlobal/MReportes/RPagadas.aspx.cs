...
public partial class RPagadas : System.Web.UI.Page
{
    ...
    {
        cReportes obj = new cReportes();
        DataTable dtReporte = obj.ReportesPagadas(int.Parse(cboEdo.SelectedValue), int.Parse(cboMunicipio.SelectedValue), int.Parse(cboTipoMulta.SelectedValue), txtFechaIni.Text, txtFechaFin.Text, txtPlaca.Text);
    ...
    protected void btnExportarExcel_Click(object sender, EventArgs e)
    {
        cReportes obj = new cReportes();
        DataTable dtReporte = obj.ReportesPagadas(int.Parse(cboEdo.SelectedValue), int.Parse(cboMunicipio.SelectedValue), int.Parse(cboTipoMulta.SelectedValue), txtFechaIni.Text, txtFechaFin.Text, txtPlaca.Text);
        fgral.ExporttoExcell(dtReporte, "Reporte Multas Pagadas");
