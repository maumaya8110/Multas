...
public partial class ConsultaE : System.Web.UI.Page
{
    ...
    {
        cReportes obj = new cReportes();
        DataTable dtReporte = obj.ReportesMultas(int.Parse(cboEdo.SelectedValue), int.Parse(cboMunicipio.SelectedValue),int.Parse(cboTipoMulta.SelectedValue), txtFechaIni.Text, txtFechaFin.Text,int.Parse( cbotReporte.SelectedValue),2);
    ...
    protected void btnExportarExcel_Click(object sender, EventArgs e)
    {
        cReportes obj = new cReportes();
        DataTable dtReporte = obj.ReportesMultas(int.Parse(cboEdo.SelectedValue), int.Parse(cboMunicipio.SelectedValue), int.Parse(cboTipoMulta.SelectedValue), txtFechaIni.Text, txtFechaFin.Text, int.Parse(cbotReporte.SelectedValue), 2);
        // fgral.ExporttoExcell(dtReporte, cbotReporte.SelectedItem.Text);
