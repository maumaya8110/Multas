...
public partial class Ccaja : System.Web.UI.Page
{
    ...
    {
        cReportes obj = new cReportes();
        DataTable dtReporte = obj.ReportesSesionCobro(int.Parse(cboEdo.SelectedValue), int.Parse(cboMunicipio.SelectedValue), txtFechaIni.Text, txtFechaFin.Text);
    ...
    protected void btnExportarExcel_Click(object sender, EventArgs e)
    {
        cReportes obj = new cReportes();
        DataTable dtReporte = obj.ReportesSesionCobro(int.Parse(cboEdo.SelectedValue), int.Parse(cboMunicipio.SelectedValue), txtFechaIni.Text, txtFechaFin.Text);
       fgral.ExporttoExcell(dtReporte, "MULTAS COBRADAS POR SESION");
